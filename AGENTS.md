...
**活跃观察项（未闭环）**：
- §59.194 挂账：午夜凶铃 tid=270313 净化词未命中（疑副标题别名形态待核对）；降级轮（mixed/purify/B 补线）无 rc 日志可观测盲区
