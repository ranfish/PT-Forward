...
**固定优惠**：
- TLF 官方作品（MiniSD/iNT）新种免费 48 小时
- TLF 官方作品种子数 < 5 时免费

### 3.9 WEBRip vs WEB-DL vs Encode 媒介区分（论坛 Post 6）

| 情况 | 应选媒介 |
|------|----------|
| 从视频网站直接下载的源视频 | WEB-DL |
| 因 DRM 限制抓取时自动重编码（NF/AMZ 等） | WEB-DL（选 WEB-DL 也可） |
| 在 WEBDL 基础上主动用 x264/x265 编码 | **Encode**（不是 WEBRip） |
| 直接录制的源码（通常 .ts 后缀） | HDTV |
| 不论 x264/x265/Xvid 编码后的作品 | Encode（BDRip/BRRip/DVDRip 都属 Encode） |
...
- 发布者获得双倍上传量
- 无 H&R 规则
- 禁止评论包括："等 iNT/MNHD/MiniSD/xx 小组的"、"等原盘"、"等国语"、"等字幕"等催促类评论
...
仅有4个选项：
- TLF HALFCD TeaM(1)：包括 HALFCD-TLF、miniSD-TLF、miniHD-TLF、miniFHD-TLF 等
- TLF iNT TeaM(2)：包括 MNHD、iNT-TLF（注意 MNHD 不同于 MNHD-FRDS；早期 iNT 作品只有 -TLF 后缀）
- Other(5)：不属于以上三者的制作组或未知制作组
- 个人原创(8)：发布者自己 rip 的原创资源

非 TLF 官方组统一选 Other(5)。个人原创内容选 个人原创(8)。
...
*分析时间：2026-04-16*
*最后更新：2026-04-22*
*数据来源：https://pt.eastgame.org/forums.php?action=viewtopic&forumid=2&topicid=1105 + https://pt.eastgame.org/rules.php + https://pt.eastgame.org/upload.php*
