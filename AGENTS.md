...
**版本**：v0.0.987（已发布——release-tag 脚本自动同步）。§59.251 下载器恒定 ID 重构已实施（批次 0-6 全链落地：18 表 ClientUID uint/全接口族 uid 化/原生 SQL 列名 32 处/前端 ~85 处/参数归一 client_id——v0.0.988 待发，交付用户删 /data 从零部署）。
