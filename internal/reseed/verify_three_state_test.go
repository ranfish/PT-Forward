...
func TestStripEpisodeNumberPrefix(t *testing.T) {
	cases := []struct{ in, wantKw, wantCN string }{
		...
		{"11.伊老师与小蟾蜍大历险.The.Adventures.of.Ichabod.and.Mr.Toad.1949.BluRay.1080p.x265.10bit.MNHD-FRDS", "The Adventures of Ichabod Mr Toad 1949", "伊老师与小蟾蜍大历险"}, // and 剥离（§59.192 A）；§59.206 超限剥规格词
	}
	for _, c := range cases {
