...
const fieldMeta: Record<string, { type: string; hint: string; unit?: string }> = {
  ...
  unregistered: { type: 'bool', hint: '' },
  unregistered_msg: { type: 'text', hint: '' },
  subscription_id: { type: 'text', hint: '' },
  name: { type: 'text', hint: '' },
...
const availableFields = [
  ...
  { value: 'unregistered', label: t('seeding.fieldUnregistered') },
  { value: 'unregistered_msg', label: t('seeding.fieldUnregisteredMsg') },
  { value: 'subscription_id', label: t('seeding.fieldSubscriptionID') },
  ...
  { value: 'is_paused', label: t('seeding.fieldIsPaused') },
  { value: 'downloaded', label: t('seeding.fieldDownloaded') },
  { value: 'error', label: t('seeding.fieldError') },
  { value: 'tracker_msg', label: t('seeding.fieldTrackerMsg') },
  { value: 'tracker_url', label: t('seeding.fieldTrackerURL') },
