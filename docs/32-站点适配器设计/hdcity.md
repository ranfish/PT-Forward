...
副标题：中文名称或其他说明，不要包含广告或求种/续种请求。

**IMDb 链接**：电影、剧集等有 IMDb 链接的**必须填写**（若不知道可到豆瓣等搜索）。

**简介要求**：
- 电影/电视剧：**必须**包含海报/封面；**必须**包含文件详细情况（格式、时长、编码、码率、分辨率、语言、字幕等）；尽可能包含截图、剧情概要、幕后制作、花絮、评论、获奖信息
- 体育节目：禁止在简介/截图/文件名中泄漏比赛结果
- 音乐：尽可能包含 CD 封面和曲目列表
- NFO 写入 NFO 区域，不要粘贴到简介

### 2.7 编码-媒介对应关系

| 编码 | 适用媒介 |
|------|---------|
| H.264/AVC | Blu-ray、HD DVD、Remux、Encode、HDTV |
| WMV/VC-1 | Encode(WMV)、Blu-ray、HD DVD、Remux、HDTV |
| DivX/XviD | DVDRip |
| MPEG-2 | Blu-ray、HD DVD、Capture、DVD |
| FLAC | CD/Track |
| APE | CD |
| DTS/DTS-ES | Encode(带DTS)、CD/Track |
| Dolby AC3 | Encode(带AC-3)、Track |
| WAV/Raw | CD |
| TrueHD/Atmos | Blu-ray/Remux/Encode |
...
**自动促销**：
- 新出的种子在放出 **12 小时内**自动免费
- 种子体积 **> 25GB** 自动免费
- 不定期开启全站免费

**注意**: 50%下载概率极高（远超大多数站点），实际大部分种子有折扣。

### 2.10 账号保留规则

1. Veteran Angel（主天使）及以上等级永久保留
2. Elite Angel（权天使）及以上等级封存账号后不会被删除
3. 封存账号连续 **180 天**不登录 → 删除
4. 未封存账号连续 **60 天**不登录 → 删除
5. 无流量账号连续 **30 天**不登录 → 删除
...
*数据来源: upload HTML (/tmp/hdcityupload.html) + rules page (2026-04-22)*
*文档更新: 2026-04-22*
