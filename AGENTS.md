...
2. PT31 OTA v0.0.881→v0.0.935+（§59.170 F2 复验 + §59.171 附生效 + PT31 批量重获治愈 ~223 簇存量 + §59.182-208 搜索修复链；243 已随 deploy-all 自动升 v0.0.935）——用户执行
