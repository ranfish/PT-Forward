...
- 高清（HD）视频：**影视类资源限发布 Blu-rayUHD、Blu-ray、x264/x265、WEB、HDTV**（不能发枪版与含广告的）
- HDTV 流媒体
- 高清重编码（至少 720p）
- 标清重编码（**只能**是来源于高清媒介的标清重编码，至少 480p）
...
- 单种上传速度限制 100MB/s，全局不限
- **超过 100MB/s 系统自动封号，上传量减半解封**
- 非发布者上传速度超过 25MB/s 的，按 **3 倍扣罚汇报上传量**
  - 例：汇报 224.98GB @ 63.99MB/s → 扣 224.98×3=674.94GB

### 2.13 账号保留规则

1. Extreme User 及以上等级永久保留
2. Elite User 及以上等级封存账号后不会被封禁
3. 封存账号连续 **150 天**不登录 → 封禁
4. 未封存账号连续 **90 天**不登录 → 封禁
5. 无流量账号连续 **14 天**不登录 → 封禁
6. 被封禁账号连续 **200 天**不登录 → 从数据库**物理删除**

### 2.14 做种积分

- 做种积分为原始无加成的做种魔力
- 做种人数越少、发布时间越久远、体积越大的种子保种越容易获得高积分
- 除保种外无其他获取途径

### 2.15 低体积资源打包

- 低于 100MB 的电子书不要单独上传，可以打包发布
- 相声之类的音频资源同理
...
*数据来源: upload.php HTML + rules.php HTML (2026-04-22)*
*文档更新: 2026-04-22*
