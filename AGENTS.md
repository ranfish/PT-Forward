...
**遗留**：发布页重构（含 tag_config 激活，§56.22，下一步主线）；MarkStatus 已修（§59.120 订阅隔离，v0.0.773，2026-08-27 关闭）；runAnalyze 已改判（随发布页重构废弃——§59.121 定案：发布流禁拉站点，缺失回种子配置修；runAnalyze 无产品入口，不投资补丁）；integration E2E flaky 已修（§59.122 SQLite cache=shared+轮询就绪，v0.0.774，2026-08-27 关闭）。已完结：批量截图并发限流（§59.58 信号量 5 实施，观察期无新问题，2026-08-26 关闭）。
