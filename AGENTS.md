...
**版本**：v0.0.972（已发布——release-tag 脚本自动同步）。
...
3. **Tab1 数据源对齐收官并实施完成（§59.226-228——v0.0.956）**；组名识别统一三层+@复合资产化（§59.233——v0.0.963/964；cqkyjj2 及 @ 复合 21 形态已 seed 化随版发布，无手动项）；遗留观察：fnos OTA 重获后数据级验证
