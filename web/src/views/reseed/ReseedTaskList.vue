  ...
  <div>
    ...
    >
      <a-form :model="form" layout="vertical">
        ...
        <a-form-item :label="t('reseed.matchMethods')" name="matchMethods">
        ...
        <a-collapse :bordered="false" style="margin-top: 8px; background: transparent">
          <a-collapse-panel key="advanced" :header="t('common.advancedOptions')">
            ...
            <a-form-item :label="t('reseed.engineMode')" name="engineMode">
...
import type { ReseedTask } from '@/api/types'
...
function openModal(record?: ReseedTask) {
  ...
  if (record) {
    Object.assign(form, {
      ...
      sourceSiteIds: record.source_site_ids || '',
      targetSiteIds: record.target_site_ids || '',
      ...
      engineMode: record.engine_mode || 'e1_manual',
