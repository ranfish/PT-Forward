...
**版本**：v0.0.958（已发布——release-tag 脚本自动同步）。
...
3. **Tab1 20 字段数据源对齐讨论收官并统一实施完成（§59.226 二十一份定案+§59.228 实施——21 字段三分区/三源重构/canonical 单点/DIY 族/中文集数/评论轨排除/印度词表，8 包回归全绿，v0.0.956）**；遗留：cqkyjj2→不可说 词条各环境手动添加
