...
- 任何人都能发布资源
- 部分用户（低烧及以下）需先在**候选区**(offers.php)提交候选
- **游戏类资源**：仅上传员及以上等级可自由上传，其他用户须先提交候选
- **中烧及以上级别**的会员可直接上传，其他需候选区申请投票上传

### 2.3 允许的资源

- 高清视频（Blu-ray/HD DVD 原碟、Remux、HDTV、重编码 ≥ 720p、高清 DV）
- **视频网站高清 WEB-DL**（讨论稿新增，rules.php 原文未列出但实际已承认）
...
**音乐(Music)**：以 SACD/CD 光盘为主要媒介，保存优先级 APE > FLAC > WAV；必须以专辑形式出现；单歌曲文件 >500MB 的高解析文件可视情况通过（稀缺资源）；出官方种清理其他。

**演唱会(Vocal Concert)**：以 Blu-Ray 光盘为主要媒介，WEB-DL 需以 >20GB 4K 资源包形式存在；出官方种清理其他。

### 2.4 不允许的资源

- DVD 及以下规格资源 / miniBD 资源
...
1. **媒介优先级**: Blu-ray/HD DVD > **HDTV/WEB-DL** > DVD > TV（讨论稿已将 WEB-DL 提升至与 HDTV 同级）
2. 高清版本代替标清
...
**副标题**: 资源简略信息（中文名、字幕信息、视频格式等）。对于纯英文种子（暂时无法找到中文名）副标题可暂时留空；对于纯中文种子可填中文名到标题栏。

**标题禁止**:
- 不允许以 avi、ts、mkv 等视频封装格式结尾
- 不允许使用各类括号、下划线、中文破折号、单双引号、书引号等符号

**种子要求细则**:
- 分辨率：3840×2160、1920x1080、1440x1080（仅 BBC/IMAX）、1280x720
- 至少出现 3 个做种者才能撤种，无任何人下载则 72 小时后可撤种
- **必须禁止 DHT 网络**
- 欧美类资源种子文件夹名必须全英文或其他欧美国家文字（文件名不做限制）
- 电影必须包含对应 IMDb 链接和中文简介

**重编码音轨配置要求**:
- 1080p/720p Rip 必须原生 5.1，或使用高级别音轨（DTSMA/TrueHD/DDPlus/LPCM）通过 EAC3To 等专业软件重编码为较低级别（DTS/AC3）
- 大陆普通话配音音轨可放宽至原生 AC3 2.0

**HDTV/WEB-DL 截图要求**:
- 媒介为 HDTV 及 WEB-DL 的资源必须包含至少 2 个以上原视频分辨率（1920x1080/1280x720/720x480/720x576）的 PNG 截图
- 不要直接将 PNG 截图链接添加到描述中，须通过带原图链接的预览图
...
- **下载 ≥ 50% 即触发 HR 计时**（包括只下主文件不完整的、蓝光原盘只下视频的）
- 未达标扣 1 HP，**HP 最低要求为 1**（HP=0 即失去下载权限）
- HP 初始值/封顶值 = 5，VIP 为 10
- HP=0 后 **20 天内未恢复即自动封禁**
- HP 恢复极难：需约连续做种 180 天兑换 1 HP（做种积分兑换）
- 黄星标志及 VIP 免除 HR
- 捐赠黄星或以上级别恢复 HP 初始值
- **三大封号原因**：HR 违规排第一，超时不登录排第二，违规辅种排第三
...
- **官方**：适用于官方制作组作品
- **首发**：仅适用于电影类资源，勾选请慎重
- **独占**（文档 §1.5 中为 `limited`/禁转）：该资源仅发布于本站，禁转转载，需确保为发布者本人原创
- **国语**：适用于作品制作语言为国外及国内香港地区的带有中国语言的作品
- **DIY**：适用于原盘 DIY
- **中字**：适用于作品制作语言为国外地区的带有中文字幕的作品
...
1. Ultimate User 及以上等级永久保留
2. Extreme User 及以上等级封存账号后不会被删除
3. 封存账号连续 90 天不登录 → 删除
4. 未封存账号连续 45 天不登录 → 删除
5. 无流量账号连续 7 天不登录 → 删除
...
*数据来源: upload.php HTML + rules.php HTML + 论坛讨论稿(topicid=13/12711/16123/13003) (2026-04-22)*
*文档更新: 2026-04-22*
