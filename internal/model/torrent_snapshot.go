...
type TorrentSnapshot struct {
	...
	ClientUID  uint     `json:"client_uid" gorm:"not null;uniqueIndex:idx_snapshot_hash_client,composite:client_uid;index:idx_snapshots_cluster,composite:client_path_name"`
