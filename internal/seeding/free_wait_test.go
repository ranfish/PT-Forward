...
func TestFreeWaitMonitor_Add(t *testing.T) {
	...
	m.Add("site-a", "123", "hash1", "Test Torrent", 1024, nil, 1, "1", false, 0, 0, 0)
...
func TestFreeWaitMonitor_Remove(t *testing.T) {
	...
	m.Add("site-a", "123", "hash1", "Test", 1024, nil, 1, "1", false, 0, 0, 0)
	assert.Equal(t, 1, m.PendingCount())
...
func TestFreeWaitMonitor_CheckOnce_BecameFree(t *testing.T) {
	...
	m.Add("site-a", "123", "hash1", "Test Torrent", 1024, nil, 1, "1", false, 0, 0, 0)
	m.Add("site-a", "456", "hash2", "Not Free", 2048, nil, 1, "1", false, 0, 0, 0)
...
func TestFreeWaitMonitor_CheckOnce_Expired(t *testing.T) {
	...
	m.Add("site-a", "123", "hash1", "Test", 1024, &before, 1, "1", false, 0, 0, 0)
...
func TestFreeWaitMonitor_ClearAll(t *testing.T) {
	...
	m.Add("site-a", "123", "hash1", "Test", 1024, nil, 1, "1", false, 0, 0, 0)
	m.Add("site-b", "456", "hash2", "Test2", 2048, nil, 1, "1", false, 0, 0, 0)
...
func TestFreeWaitMonitor_AddEmptyTorrentID(t *testing.T) {
	...
	m.Add("site-a", "", "hash1", "Test", 1024, nil, 1, "1", false, 0, 0, 0)
	assert.Equal(t, 0, m.PendingCount())
}
...
func TestFreeWaitMonitor_RecoverOnStartup(t *testing.T) {
	...
	m.Add("site-a", "123", "hash1", "Test", 1024, nil, 1, "1", false, 0, 0, 0)
	m.Add("site-b", "456", "hash2", "Test2", 2048, nil, 1, "2", true, 72, 0, 0)
